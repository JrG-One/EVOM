...
async function sendMail(email, uniqueString) {
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 30px 40px;">
      <h2 style="color: #0062cc; margin-top: 0;">Welcome to InterviewWhiz!</h2>
      <p>Hello future interview champion,</p>
      <p>Thank you for joining InterviewWhiz - your personal interview preparation assistant. We're excited to help you ace your next interview and land your dream job!</p>
      ...
      <p>Best regards,<br>The InterviewWhiz Team</p>
    </div>
    ...
    <div style="background-color: #f5f5f5; padding: 20px; text-align: center; color: #666; font-size: 14px; border-top: 1px solid #eaeaea;">
      ...
      <p style="margin: 5px 0;">InterviewWhiz Inc.</p>
      <p style="margin: 5px 0;">Founded by navJyotish | Kamrej</p>
      <p style="margin: 5px 0;">&copy; 2025 InterviewWhiz. All rights reserved.</p>
      <p style="margin: 5px 0;"><small>If you didn't sign up for InterviewWhiz, please disregard this email.</small></p>
    </div>
  </div>
</div>
      `,
